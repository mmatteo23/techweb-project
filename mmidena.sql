...
--
-- Host: localhost:3306
-- Generation Time: Feb 01, 2022 at 08:48 PM
...
INSERT INTO `Game` (`id`, `name`, `description`, `release_date`, `developer`, `game_img`) VALUES
(1, 'League of Legends', 'League of Legends is a team-based strategy game where two teams of five powerful champions face off to destroy the other’s base. Choose from over 140 champions to make epic plays, secure kills, and take down towers as you battle your way to victory.', '2009-10-27', 'Riot Games', '1.jpg'),
(2, 'Valorant', 'Blend your style and experience on a global, competitive stage. You have 13 rounds to attack and defend your side using sharp gunplay and tactical abilities. And, with one life per-round, you’ll need to think faster than your opponent if you want to survive. Take on foes across Competitive and Unranked modes as well as Deathmatch and Spike Rush.', '2020-06-02', 'Riot Games', '2.jpg'),
(3, 'Clash Royale', 'Enter the Arena! From the creators of Clash of Clans comes a real-time multiplayer game starring the Royales, your favorite Clash characters and much, much more. Collect and upgrade dozens of cards featuring the Clash of Clans troops, spells and defenses you know and love, as well as the Royales: Princes, Knights, Baby Dragons and more. Knock the enemy King and Princesses from their towers to defeat your opponents and win Trophies, Crowns and glory in the Arena. Form a Clan to share cards and build your very own battle community.', '2016-03-02', 'Supercell', '3.jpg'),
(4, 'Apex Legends', 'Pick your character. Round up your squad. Show everyone what Legends are made of. Whether you’re battling on a massive floating city in Battle Royale or dueling in close-quarters Arenas, you’ll need to think fast. Master your Legend’s unique abilities and coordinate with your teammates to discover new tactics and powerful combinations. Master an expanding assortment of powerful weapons and equipment. You’ll need to move fast and learn the rhythms of each weapon to get the most from your arsenal. Plus change it up in limited-time modes, and get ready for a boatload of new content each season. Apex Legends takes place in an immersive universe where the story continues to evolve, maps change each season, and new Legends keep joining the fight. Make your mark on the Apex Games with a multitude of distinct outfits and join the adventure!', '2019-02-04', 'Respawn Entertainment', '4.jpg'),
(5, 'Rocket League', 'Rocket League, the sequel to Supersonic Acrobatic Rocket-Powered Battle-Cars, is a popular videogame that combines soccer and cars into its gameplay. For those who enjoy high-octane reckless driving and the world’s most popular sport, Rocket League is the game for you. This cross-genre arena battler is the latest craze on PC, PS4, Xbox One and Nintendo Switch. Fun for all players and abilities, the game offers both a casual and competitive atmosphere, as well as a ton of laughs.', '2015-07-07', 'Psyonix Studios', '5.jpg'),
(6, 'Counter-Strike: Global Offensive', 'Counter-Strike: Global Offensive (CS: GO) expands upon the team-based action gameplay that it pioneered when it was launched 19 years ago. CS: GO features new maps, characters, weapons, and game modes, and delivers updated versions of the classic CS content ', '2012-08-21', 'Valve Corporation', '6.jpg'),
(7, 'DOTA 2', 'Every day, millions of players worldwide enter the battle as one of over a hundred Dota Heroes in a 5v5 team clash. Dota is the deepest multi-player action RTS game ever made and there’s always a new strategy or tactic to discover. It’s completely free to play and always will be - start defending your ancient now.', '2013-07-09', 'Valve Corporation', '7.jpg'),
(8, 'FIFA', 'The legendary FIFA series has been produced by EA SPORTS for over 20 years, and is now the largest sports video game franchise on the planet. FIFA brings The World’s Game to life, letting you play with the biggest leagues, clubs, and players in world football, all with incredible detail and realism. Whether you want to build your dream squad in FIFA Ultimate Team, lead your favourite club to glory in Career Mode, take the game back to the streets with EA SPORTS VOLTA FOOTBALL, or get bragging rights over a friend in Kick-Off Mode, the FIFA series lets you play The World’s Game your way.', '1993-12-15', 'Electronic Arts', '8.jpg'),
(9, 'Fortnite', 'Fortnite is a massive multiplayer online video game released in July 2017, developed by Epic Games. The game includes two different game modes released as early access: Save the World and Battle Royale. Fortnite Battle Royale is the free 100-player PvP mode in Fortnite. One giant map, a battle bus, Fortnite building skills and destructible environments combined with intense PvP combat while the last one standing wins; and Save the World is a cooperative shooter-survival game with up to 4-man squad to fight off husks and defend mission objectives with fortifications and defenses.', '2017-07-21', 'Epic Games', '9.jpg'),
(10, 'Minecraft', 'Minecraft is a sandbox construction video game developed by Mojang Studios where players interact with a fully modifiable three-dimensional environment made of blocks and entities. Its diverse gameplay lets players choose the way they play, allowing for countless possibilities.', '2011-11-18', 'Mojang', '10.jpg'),
(11, 'Overwatch', 'Overwatch is a vibrant team-based shooter set on a near-future earth. Every match is an intense 6v6 battle between a cast of unique heroes, each with their own incredible powers and abilities. Clash in over 20 maps from across the globe, and switch heroes on the fly to adapt to the ever-changing situation on the field.', '2016-05-24', 'Blizzard Entertainment', '11.jpg'),
(12, 'Warzone', 'Warzone™ Pacific arrives with a new map, trading in the Eastern European front of Verdansk for the sunny Pacific island of Caldera. With plenty of tropical landscapes to explore, there’s always some action above and below the surface. And for an action-packed World War II experience, take to the skies in Vanguard Royale, a new Warzone-based game mode featuring a fighter plane and Anti-Aircraft vehicles.', '2020-03-10', 'Activision', '12.jpg'),
(13, 'Pok&#233;mon Unite', 'Pok&#233;mon Unite is a free-to-play videogame published by Timi Studio Group for Nintendo Swtich Console first.', '2021-07-21', 'TiMi Studio Group', '13.jpg');
...
(10, 'adventure'),
(11, 'MMO'),
(12, 'driving/racing game'),
(13, 'card game'),
(14, 'RPG'),
(15, 'horror'),
(16, 'puzzle'),
(17, 'indie'),
(18, 'rhythm & music game'),
(19, 'platformer'),
(20, 'arcade');
...
--
-- Table structure for table `liked_articles`
--
...
--
-- Dumping data for table `liked_articles`
--

INSERT INTO `liked_articles` (`username`, `article_id`) VALUES
('danilostojkovic', 2),
('danilostojkovic', 12),
('davidemilan', 2),
('davidemilan', 3),
...
INSERT INTO `Person` (`username`, `firstName`, `lastName`, `email`, `password`, `role`, `subscription_date`, `profile_img`) VALUES
('admin', 'admin', 'admin', 'admin@pentanews.com', 'admin', 1, '2022-02-01', ''),
('danilostojkovic', 'Danilo', 'Stojkovic', 'danilo.stojkovic@pentanews.com', 'danilostojkovic', 1, '2022-02-01', 'danilostojkovic.png'),
('davidemilan', 'Davide', 'Milan', 'davide.milan@pentanews.com', 'davidemilan', 1, '2022-02-01', 'davidemilan.png'),
('matteocasonato', 'Matteo', 'Casonato', 'matteo.casonato@pentanews.com', 'matteocasonato', 1, '2022-02-01', 'matteocasonato.png'),
('matteomidena', 'Matteo', 'Midena', 'matteo.midena@pentanews.com', 'matteomidena', 1, '2022-02-01', 'matteomidena.jpg'),
('user', 'user', 'user', 'user@useremail.com', 'user', 3, '2022-02-01', ''),
('writer', 'writer', 'writer', 'writer@writeremail.com', 'writer', 2, '2022-02-01', '');
...
INSERT INTO `saved_articles` (`username`, `article_id`) VALUES
('danilostojkovic', 1),
('davidemilan', 1),
('davidemilan', 3),
('davidemilan', 5),
...
--
-- Stand-in structure for view `SearchRelatedArticles`
-- (See below for the actual view)
--
CREATE TABLE `SearchRelatedArticles` (
`id` int(11)
,`title` varchar(255)
,`subtitle` text
,`game` varchar(100)
...
--
-- Stand-in structure for view `topArticles`
-- (See below for the actual view)
--
...
--
-- Structure for view `SearchRelatedArticles`
--
DROP TABLE IF EXISTS `SearchRelatedArticles`;

CREATE ALGORITHM=UNDEFINED DEFINER=`mmidena`@`localhost` SQL SECURITY DEFINER VIEW `SearchRelatedArticles`  AS  (select `Article`.`id` AS `id`,`Article`.`title` AS `title`,`Article`.`subtitle` AS `subtitle`,`Game`.`name` AS `game`,`Article`.`publication_date` AS `publication_date`,`Article`.`cover_img` AS `cover_img`,`Article`.`alt_cover_img` AS `alt_cover_img` from (`Article` join `Game` on(`Article`.`game_id` = `Game`.`id`)) where `Game`.`name` = 'Counter-Strike: Global Offensive 3' group by `Article`.`title` order by `Article`.`publication_date` desc) ;

-- --------------------------------------------------------

--
-- Structure for view `topArticles`
--
DROP TABLE IF EXISTS `topArticles`;

CREATE ALGORITHM=UNDEFINED DEFINER=`mmidena`@`localhost` SQL SECURITY DEFINER VIEW `topArticles`  AS  (select `Article`.`id` AS `id` from `Article` order by `Article`.`publication_date` desc limit 0,7) ;
...
--
-- Indexes for table `liked_articles`
--
ALTER TABLE `liked_articles`
  ADD PRIMARY KEY (`username`,`article_id`),
  ADD KEY `article_id` (`article_id`);
...
--
ALTER TABLE `Article`
  ADD CONSTRAINT `Article_ibfk_1` FOREIGN KEY (`author`) REFERENCES `Person` (`username`) ON DELETE CASCADE,
  ADD CONSTRAINT `Article_ibfk_2` FOREIGN KEY (`game_id`) REFERENCES `Game` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `article_tags`
--
ALTER TABLE `article_tags`
  ADD CONSTRAINT `article_tags_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `Tag` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `article_tags_ibfk_2` FOREIGN KEY (`article_id`) REFERENCES `Article` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `liked_articles`
--
ALTER TABLE `liked_articles`
  ADD CONSTRAINT `liked_articles_ibfk_1` FOREIGN KEY (`username`) REFERENCES `Person` (`username`) ON DELETE CASCADE,
  ADD CONSTRAINT `liked_articles_ibfk_2` FOREIGN KEY (`article_id`) REFERENCES `Article` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `Person`
--
ALTER TABLE `Person`
  ADD CONSTRAINT `Person_ibfk_1` FOREIGN KEY (`role`) REFERENCES `Role` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `saved_articles`
--
ALTER TABLE `saved_articles`
  ADD CONSTRAINT `saved_articles_ibfk_1` FOREIGN KEY (`username`) REFERENCES `Person` (`username`) ON DELETE CASCADE,
  ADD CONSTRAINT `saved_articles_ibfk_2` FOREIGN KEY (`article_id`) REFERENCES `Article` (`id`) ON DELETE CASCADE;
COMMIT;
